int getCodePage437Character(int index, int y) {
    unsigned int characters_codepage437_0[][150] = {    {
        // code x20
        0b00000000, // 0
        0b00000000, // 1
        0b00000000, // 2
    ...
    unsigned int characters_codepage437_1[][150] = {    {
        // code x2d
        0b00000000, // 0
        0b00000000, // 1
        0b00000000, // 2
    ...
    unsigned int characters_codepage437_2[][150] = {    {
        // code x3a
        0b00000000, // 0
        0b00000000, // 1
        0b00000000, // 2
    ...
    unsigned int characters_codepage437_3[][150] = {    {
        // code x47
        0b00000000, // 0
        0b00000000, // 1
        0b00111100, // 2   ****
    ...
    unsigned int characters_codepage437_4[][150] = {    {
        // code x54
        0b00000000, // 0
        0b00000000, // 1
        0b11111111, // 2 ********
    ...
    unsigned int characters_codepage437_5[][150] = {    {
        // code x61
        0b00000000, // 0
        0b00000000, // 1
        0b00000000, // 2
    ...
    unsigned int characters_codepage437_6[][150] = {    {
        // code x6e
        0b00000000, // 0
        0b00000000, // 1
        0b00000000, // 2
    ...
    unsigned int characters_codepage437_7[][150] = {    {
        // code x7b
        0b00000000, // 0
        0b00000000, // 1
        0b00001110, // 2     ***
