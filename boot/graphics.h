...
#define FramebufferAddr 0xffff0

extern const int font_codepage437_width;
extern const int font_codepage437_height;

// from lecture
int getCodePage437Character(int index, int y);
